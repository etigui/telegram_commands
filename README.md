...
We are going to add the script to the web server. The script must be accesible from internet.
Here the script [qtrezbemwmxwzrqunpsyipfejqjg05bw.php](/src/qtrezbemwmxwzrqunpsyipfejqjg05bw.php)
